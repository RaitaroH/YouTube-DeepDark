...
(function() {var css = [
	...
	"	}",
	"		  .watch-stage-mode #theater-background,#creator-appbar-actions-bar,body,#page-container,#body-container,#appbar-nav,.share-panel-url,.share-panel-start-at-time,.share-embed-code,.share-email .share-email-recipients, .share-email .share-email-note {",
