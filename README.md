...
Credit for some of the color palettes in use: [@KDE](https://github.com/KDE), [@horst3180](https://github.com/horst3180), [@morhetz](https://github.com/morhetz), [@sainnhe](https://github.com/sainnhe), [@linuxmint](https://github.com/linuxmint), [Firefox](https://www.mozilla.org/en-US/firefox/new/), [YouTube](https://www.youtube.com/) and [Discord](https://discordapp.com/)

Code also taken from [youtube-custom-colors-video-progress-bar](https://userstyles.org/styles/95280/youtube-custom-colors-video-progress-bar) for the video theming.
