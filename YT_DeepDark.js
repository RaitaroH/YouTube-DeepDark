...
(function() {var css = [
  ...
  ".comment-renderer.channel-owner .comment-author-text{",
	...
	"			border-color: #444 !important;",
	"	}",
	"		  .tabs .tab-header:hover,.tabs .tab-header.selected,.yt-gb-shelf-item-thumbtab.yt-gb-selected-shelf-tab::before,.epic-nav-item-heading,.epic-nav-item-heading:hover{",
	"			border-color: #00adee !important;",
	"	}",
	"	",
